...
import doanvat.webmvc.dao.impl.RegisterDao;
import doanvat.webmvc.jdbc.connectDB;
...
@WebServlet(name = "ClientRegister", urlPatterns = {"/view/client/register"})
public class RegistrationController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		{
			request.setAttribute("Message", "Bạn đã tạo tài khoàn thành công. Mời bạn đăng nhập <a href='/WebBanDoAnVat/view/client/login'>tại đây!</a>");
