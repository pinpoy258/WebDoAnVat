          ...
          <div class="navbar-collapse collapse">
            ...
            <li><a href="${pageContext.request.contextPath}/view/client/product">SẢN PHẨM</span></a>
                <ul class="dropdown-menu">                
                  <li><a href="product.jsp">Trà Sữa</a></li>
                  <li><a href="product.jsp">Bánh Tráng</a></li>
                  <li><a href="product.jsp">Cá Viên</a></li>
                  <li><a href="product.jsp">Gỏi Cuốn & Gỏi Đu Đủ</a></li>
                </ul>
              </li>
